...
Item {
    ...
    property var f_rc_roll: field("rc_roll")
    property var f_rc_pitch: field("rc_pitch")
    property var f_lat: field("gps_lat")
    property var f_lon: field("gps_lon")
    property var f_yaw: field("yaw")
    property var f_roll: field("roll")
    property var f_pitch: field("pitch")

    property var f_home_lat: field("home_lat")
    property var f_home_lon: field("home_lon")

    //internal [levelXY 0..1]
    property double px: mapProvider.lonToX(m.f_lon.value)
    property double py: mapProvider.latToY(m.f_lat.value)
