...
static constexpr void _check_filter_control_status_fields()
{
    ...
    (void) u.flags.in_transition;
    (void) u.flags.heading_observable;
    (void) u.flags.rngbcn_fusion;
    (void) u.flags.armed;
}
...
static const QVector<EkfBitEntry> s_filterControlStatusHi = {
    ...
    {48, QStringLiteral("in_transition"), colorNone},
    {49, QStringLiteral("heading_observable"), colorNone},
    {50, QStringLiteral("rngbcn_fusion"), colorNone},
    {51, QStringLiteral("armed"), colorRed},
};
