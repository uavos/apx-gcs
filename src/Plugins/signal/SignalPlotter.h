...
/** \brief The SignalPlotter widget draws a real time graph of data that updates continually
 *
 *  Features include:
 ...
 *  Example usage:
 *  \code
 *    SignalPlotter *s = SignalPlotter(parent);
 *    s->addBeam(Qt::Blue);
 *    s->addBeam(Qt::Green);
 *    QList data;
 *    data << 4.0 << 5.0;
 ...
 *
 *  \image SignalPlotter.png  Example SignalPlotter with two beams
 */
