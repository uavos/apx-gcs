...
export function sys_time_decorator(value: any) {
    let true_type_value = Number(value)
    return epochToDateTime(true_type_value)
}

export function tel_time_decorator(value: any) {
    let true_type_value = Number(value)

    return true_type_value.toFixed(2) + " s"
}

export function duration_decorator(value: any) {
    let true_type_value = Number(value)

    return secondsToHMS(true_type_value)
}

export function time_decorator(value: any) {
