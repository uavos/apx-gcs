...
Item {
    ...
    property var paramsFact: pageFact ? pageFact.child(2) : null
    ...
    ColumnLayout {
        ...
        FactButton {
            ...
            fact: root.pageFact ? root.pageFact.child(0) : null
            noFactTrigger: true
        ...
        FactButton {
            Layout.fillWidth: true
            visible: root.pageFact !== null
            fact: root.pageFact ? root.pageFact.child(1) : null
            noFactTrigger: true
            onTriggered: root.triggerFact(fact)
        }
        ...
        ListView {
            ...
            clip: true
            spacing: 0
            model: root.paramsFact ? root.paramsFact.model : null
