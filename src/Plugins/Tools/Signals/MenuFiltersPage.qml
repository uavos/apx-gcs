...
Item {
    ...
    property var listFact: pageFact ? pageFact.filtersFact : null
    ...
    ColumnLayout {
        ...
        FactButton {
            ...
            fact: root.pageFact ? root.pageFact.newFilterTypeFact : null
            noFactTrigger: true
        ...
        FactButton {
            Layout.fillWidth: true
            visible: root.pageFact !== null
            fact: root.pageFact ? root.pageFact.addFilterFact : null
            noFactTrigger: true
            onTriggered: root.triggerFact(fact)
        }
