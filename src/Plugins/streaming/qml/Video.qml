...
Rectangle {
    ...
    readonly property var stream: apx.tools.video
    ...
    BusyIndicator {
        visible: apx.tools.video.connectionState === GstPlayer.STATE_CONNECTING
        anchors.centerIn: parent
        running: true
    }
    ...
    ColumnLayout {
        ...
        CleanButton {
            iconName: "close"
            onTriggered: apx.tools.video.show_window.value = false
        }
        CleanButton {
            visible: running
            iconName: "record-rec"
