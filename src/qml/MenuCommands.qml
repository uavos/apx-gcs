...
GCSMenu {
    ...
    menu: GCSMenuItem {
        ...
        GCSMenuItem {
            ...
            GCSMenuItem { separator: true;}
            GCSMenuItem { title: qsTr("Start engine"); onClicked: ctrb_starter.setValue(!ctrb_starter.value); busy: sw_starter.value; }
        }
        GCSMenuItem {
            title: qsTr("Power")
        ...
        GCSMenuItem { separator: true; }
        GCSMenuItem { title: qsTr("RESET")+" "+mode.text; onClicked: stage.setValue(100); busy: stage.value===100; }
