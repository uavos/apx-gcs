  ...
  : QGeoTiledMappingManagerEngine()
{
  ...
  //qmlRegisterUncreatableType<GeoTiledMap>("GCS.Map", 1, 0, "GeoTiledMap", "Reference only");
  ...
  mapTypes << QGeoMapType(QGeoMapType::HybridMap, "Hybrid Map","hybrid map",false,false,TileLoader::GoogleHybrid,pname,cameraCaps);
  mapTypes << QGeoMapType(QGeoMapType::SatelliteMapDay, "Satellite Map","satellite map",false,false,TileLoader::GoogleSatellite,pname,cameraCaps);
