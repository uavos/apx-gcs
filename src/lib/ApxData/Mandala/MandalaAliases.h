...
const std::map<std::string, std::string> ALIAS_MAP = {
    ...
    // malias("cam_ctrb_shtr"),
    // malias("cam_ctrb_arm"),
    // malias("cam_ctrb_rec"),
    // malias("cam_ctrb_zin"),
    // malias("cam_ctrb_zout"),
    // malias("cam_ctrb_aux"),
    // malias("cam_tperiod","cmd.cam.tperiod"),
    // malias("cam_timestamp","cmd.cam.timestamp"),

    // malias("turretcmd_pitch"),
    // malias("turretcmd_yaw"),
    // malias("turretctr_roll"),
    // malias("turretctr_pitch"),
    // malias("turretctr_yaw"),
    // malias("turret_mode","est.turret.mode"),
    // malias("turretenc_pitch"),
    // malias("turretenc_yaw"),
