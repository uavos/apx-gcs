...
const std::map<std::string, mandala::uid_t> ALIAS_MAP = {
    ...
    // malias<mandala::sns::nav::platform::lat>("platform_lat"),
    // malias<mandala::sns::nav::platform::lon>("platform_lon"),
    // malias<mandala::sns::nav::platform::hmsl>("platform_hmsl"),
    // malias<mandala::sns::nav::platform::Vnorth>("platform_Vnorth"),
    // malias<mandala::sns::nav::platform::Veast>("platform_Veast"),
    // malias<mandala::sns::nav::platform::Vdown>("platform_Vdown"),
    // malias<mandala::sns::nav::platform::hdg>("platform_hdg"),

    // malias<mandala::sns::nav::radar::range>("range"),
    // malias<mandala::sns::nav::radar::Vx>("radar_Vx"),
    // malias<mandala::sns::nav::radar::Vy>("radar_Vy"),
    // malias<mandala::sns::nav::radar::Vz>("radar_Vz"),
    // malias<mandala::sns::nav::radar::dx>("radar_dx"),
    // malias<mandala::sns::nav::radar::dy>("radar_dy"),
    // malias<mandala::sns::nav::radar::dz>("radar_dz"),
    ...
    // malias<mandala::est::nav::turret::pitch>("turret_pitch"),
    // malias<mandala::est::nav::turret::heading>("turret_heading"),
    ...
    // malias<mandala::est::nav::turret::sw1>("turret_sw1"),
    // malias<mandala::est::nav::turret::sw2>("turret_sw2"),
    // malias<mandala::est::nav::turret::sw3>("turret_sw3"),
    // malias<mandala::est::nav::turret::sw4>("turret_sw4"),
    ...
    // malias<mandala::est::nav::ls::roll>("ls_roll"),
    // malias<mandala::est::nav::ls::pitch>("ls_pitch"),
    // malias<mandala::est::nav::ls::cp>("ls_cp"),
    // malias<mandala::est::nav::ls::spd>("ls_spd"),
    // malias<mandala::est::nav::ls::ail>("ls_ail"),
    // malias<mandala::est::nav::rs::roll>("rs_roll"),
    // malias<mandala::est::nav::rs::pitch>("rs_pitch"),
    // malias<mandala::est::nav::rs::cp>("rs_cp"),
    // malias<mandala::est::nav::rs::spd>("rs_spd"),
    // malias<mandala::est::nav::rs::ail>("rs_ail"),
    // malias<mandala::est::nav::vshape>("vshape"),
    // malias<mandala::cmd::nav::vshape>("cmd_vshape"),
    // malias<mandala::est::nav::lrs::roll>("lrs_croll"),
